...
features = ["Base" , "Base+Adapter", "Base+Adapter+Linear", "NS+Adapter"  ]
...
filenames = ["results/fig10a_base.log", "results/fig10a_base_adapter.log", "results/fig10a_base_adapter_linear.log"]
